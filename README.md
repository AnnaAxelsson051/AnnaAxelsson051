...
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dotnetcore/dotnetcore-original.svg" alt="csharp" width="50" height="50"/> 
...
SQL | Spring Boot | Spring-Data-JPA | Javafx | Scene Builder | FXML | REST | Thymeleaf | Jdbc | Json | Mockito | JUnit | Maven | YAML | Password encryption | MVC | Github API | Github Actions CI/CD | Gradle | .NET | Entity Framework | Minimal API | Linq | DbGate | Azure datastudio | Markdown | Bootstrap | Three.js | Kaboom.js | Animations | Vite | Redux | Router-dom | Axios | Scaleability - Mobile First | Webstorm | IntelliJ | Visual Studio | VSCode | Spring tool suite | Vim | Git | Bash | Mermaid | Lucid Chart | Draw.io | Postman | Kanban | Trello | Agile & Scrum | Web Content Accessibility Guidelines | It-law | Gdpr
<!--
