...
SQL | Markdown | Spring Boot | JPA | Javafx | Scene Builder | FXML | REST | Thymeleaf | JUnit | Jdbc | Json | Mockito | Maven | YAML | Github API | Github Actions CI/CD | MVC | Gradle | .NET | Minimal API | DbGate | Azure datastudio | Bootstrap | three.js | kaboom.js | Scaleability - Mobile First | Webstorm | IntelliJ | Visual Studio | VSCode | Spring tool suite | Vim | Git | Bash | Mermaid | Lucid Chart | Draw.io | Postman | Kanban | Trello | Agile & Scrum | Web Content Accessibility Guidelines | It-law | Gdpr
<!--
